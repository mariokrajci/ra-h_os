...
export async function POST(request: NextRequest) {
  try {
    ...
    // Skip AI for staged ingestion nodes — content isn't available yet; description
    // will be generated by the finalizer once extraction completes.
    const isStagedIngestion = body.metadata?.staged_ingestion === true;
    ...
    if (!nodeDescription && !isStagedIngestion) {
      try {
